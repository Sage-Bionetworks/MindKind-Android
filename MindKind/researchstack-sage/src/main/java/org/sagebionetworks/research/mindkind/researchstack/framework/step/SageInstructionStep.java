...
public class SageInstructionStep extends InstructionStep {
    ...
    public SageInstructionStep() {
        super();
    }

    public SageInstructionStep(String identifier, String title, String detailText) {
        super(identifier, title, detailText);
    }

    @Override
    public Class getStepLayoutClass() {
        return SageInstructionStepLayout.class;
    }
